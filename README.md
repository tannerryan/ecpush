...
RabbitMQ client package, now maintained by the RabbitMQ team as
[amqp091-go](https://github.com/rabbitmq/amqp091-go). I would also like to thank
Environment Canada and the awesome people at Shared Services Canada for their
developments and "openness" of MetPX and
